from .localsettings import (
    ...
    MEDIA_ROOT, ACSERVERROOT, ACSERVERWRAPPERROOT, ACSERVEREXE, ACWRAPPEREXE,
    DEFAULT_ADMIN_PASSWORD, ABSOLUTE_URL, STEAM_WEB_API, DEBUG,
    CSRF_TRUSTED_ORIGINS, LOG_FILENAME, JOIN_IP, JOIN_PORT)
import os
